...
Once the `conda-forge` channel has been enabled, `libtorch, pytorch, pytorch-gpu` can be installed with `conda`:

```
conda install libtorch pytorch pytorch-gpu
```

or with `mamba`:

```
mamba install libtorch pytorch pytorch-gpu
```
