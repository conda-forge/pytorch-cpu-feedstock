...
if [[ "$OSTYPE" == "darwin"* ]]; then
    export CXXFLAGS="$CXXFLAGS -Wno-deprecated-declarations -Wno-error=maybe-uninitialized -Wno-error=unused-command-line-argument"
    export CFLAGS="$CFLAGS -Wno-deprecated-declarations -Wno-error=maybe-uninitialized -Wno-error=unused-command-line-argument"
else
